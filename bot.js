...
CLIENT.on('messageReactionAdd', (_reaction, _user) => {
	...
	else if (_reaction.message.channel.guild.members.cache.get(_user.id).roles.has(_reaction.message.channel.guild.roles.cache.find(r => r.name == PP_EXPERT_ROLE).id)) {
