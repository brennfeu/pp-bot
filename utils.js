module.export function getRandomPercent() {
	var i = Math.floor(Math.random() * 100 + 1);
	return i;
}

module.export function changeTextUwu(_texte) {
	var lettres = [];
...
module.export function changeTextLeet(_texte) {
...
module.export function changeTextRandomCap(_texte) {
...
module.export function changeTextRussian(_texte) {
	var lettres = _texte.split(" ");
...
module.export function changeTextRandomSpoil(_texte) {
	var lettres = _texte.split(" ");
...
module.export function changeTextChristian(_texte) {
...
module.export function changeTextPoopoo(_texte) {
	_texte = _texte.split("PP").join("Poopoo");
	_texte = _texte.split("Pp").join("Poopoo");
	return _texte;
}

module.export function shuffleArray(array) {
...
module.export function randomFromList(_list) {
	if (_list.length == 0) {
		return null;
	}
...
module.export function fibonacciNumber(_n) {
	var a = 1, b = 0, temp;
	while (_n >= 0 ){
		temp = a;
		a = a + b;
...
module.export function getPriestRoleName(_god) {
